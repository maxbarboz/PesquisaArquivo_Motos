	...
	public static void main(String[] args) {
		...
		//do {
			...
			case 5:
				...
				/* informa um novo valor para tamanhoArquivos
			case 6: 
				tamanhoDados = getQtoMotos(tamanhoArquivo);

				motos = new DadosMotos("motos.txt", tamanhoDados);
				moto = new Motos [tamanhoDados];
